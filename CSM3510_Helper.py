...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def sin_result_int_call(self, value):
        if value == self.csm_helper.test_PASS:
            self.textBrowser_result.setSource(QUrl("./resource/pass.html"))
        elif value == self.csm_helper.test_FAIL:
            self.textBrowser_result.setSource(QUrl("./resource/fail.html"))
...
class MyPrinter:
    ...
    def print_img_info(str):
        ...
        image_info =Image.open ("./resource/mac.png")
        image_logo = Image.open("./resource/logo.jpg")
        x, y = image_info.size
        ...
        pre_image.save("./resource/result.png")
        image = QImage()
        image.load("./resource/result.png")
